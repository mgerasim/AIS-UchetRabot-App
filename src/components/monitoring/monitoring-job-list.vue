...
<div class="full-size v-flex no-select">
    ...
    <div class="filter-row">
        <job-list-filter-row @apply="applyFilter" :show-date-filter="false"></job-list-filter-row>
    </div>
    ...
    data() {
        return {
            ...
            columns: [
                ...
                { field: "JobStatus", title: "Состояние работы", width: 140, cell: 'jobStatusTemplate' },
            ],
