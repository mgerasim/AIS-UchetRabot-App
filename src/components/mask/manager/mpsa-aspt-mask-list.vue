...
import MpsaMaskEditor from '@/components/mask/manager/mpsa-mask-editor.vue';
import AsptMaskEditor from '@/components/mask/manager/aspt-mask-editor.vue';
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        function onChange(item: ISimpleMask) {
            let editor;
            if(props.system == 'MPSA') editor = MpsaMaskEditor; 
            if(props.system == 'ASPT') editor = AsptMaskEditor;
