        ...
        <ValidationObserver ref="observer" v-slot="{ invalid }" tag="div" slim>
            ...
            <div class="d-container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row form-group">
                        <label for="isProtectionInput" class="control-label col-md-4">Является входом защиты</label>
                        <div class="col-md-6">
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const title =  props.id == null ? 'Создание новой защиты САУ' : 'Изменение защиты САУ';
        const maskSourceEngine = computed(() => context.root.$store.state.maskSourceEngines.find(p => p.Name == 'OPC')); 
        let model = ref({
            id: undefined as (number | undefined),
            name: undefined as (string | undefined),
            type: { Value: undefined, Name: undefined } as IEnumModel, //защита/готовность
            number: undefined as (number | undefined),
            sourceEngine: maskSourceEngine,
            source: undefined as (string | undefined),
            logMessage: undefined as (string | undefined),
            isDeleted: false,
            isProtectionInput: false,   //является входом защиты
        });
