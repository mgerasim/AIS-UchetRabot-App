<template>
    <vu-modal :isScroll="true" size="p50" :center="true" :escapable="true" :dismissable="false" className="d-modal" headerClassName="d-header">
        ...
        <div class="d-container">
            <div class="form-group">
                ...
                <div class="col-12" style="padding-top: 8px;">
                    <input v-model="text" class="form-control" :required="required" />
                </div>
            </div>
        </div>
        ...
        <div slot="footer">
            <div class="d-actions">
                <button class='btn btn-sm btn-secondary d-action-button' :disabled="required && (text == null || text == '')" @click="onConfirm">OK</button>
